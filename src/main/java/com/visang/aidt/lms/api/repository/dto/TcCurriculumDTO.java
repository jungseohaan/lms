...
public class TcCurriculumDTO {
    ...
    public static TcCurriculumDTO mapToDto(Map<String,Object> data) {
        ObjectMapper objectMapper = new ObjectMapper();
        TcCurriculumDTO dto = objectMapper
                .convertValue(data, TcCurriculumDTO.class);
        return dto;
    }

    public static TcCurriculumEntity mapToEntity(Map<String,Object> data) {
        ObjectMapper objectMapper = new ObjectMapper();
        TcCurriculumEntity entity = objectMapper
                .convertValue(data, TcCurriculumEntity.class);
        return entity;
    }

    public static TcCurriculumDTO toDTO(TcCurriculumEntity entity) {
        return TcCurriculumDTO.builder()
                .id(entity.getId())
                ...
                .textbkIdxNm(entity.getTextbkIdxNm())
